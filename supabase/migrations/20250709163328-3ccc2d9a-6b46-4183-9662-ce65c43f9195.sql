...
CREATE TABLE IF NOT EXISTS view_tracking (
  ...
  UNIQUE(content_id, content_type, viewer_fingerprint, DATE_TRUNC('hour', viewed_at))
);
...
CREATE INDEX idx_view_tracking_content ON view_tracking(content_id, content_type);
CREATE INDEX idx_view_tracking_fingerprint_time ON view_tracking(viewer_fingerprint, viewed_at);
CREATE INDEX idx_view_tracking_content_hour ON view_tracking(content_id, content_type, DATE_TRUNC('hour', viewed_at));
