...
-- Fix RLS Performance Issues - Use auth.uid() instead of current_setting pattern
-- This will eliminate the "Auth RLS Initialization Plan" warnings
...
-- Create efficient RLS policies using auth.uid() directly

-- Profiles table policies (most efficient)
...
-- Posts table policies (efficient)
...
-- Comments table policies (efficient)
...
-- Post likes table policies (efficient)
...
-- Post saves table policies (efficient)
...
-- Stories table policies (efficient)
...
-- Media assets table policies (efficient)
...
-- Live streams table policies (efficient)
...
-- Dating ads table policies (efficient)
...
-- Notifications table policies (efficient)
