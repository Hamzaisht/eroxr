...
-- First, let's completely drop the problematic RLS policies that are causing infinite recursion
...
-- Also fix any potential issues with the RPC function parameters
