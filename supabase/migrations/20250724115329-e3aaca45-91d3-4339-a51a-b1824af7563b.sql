...
-- Fix 4: Add missing RLS policies and remove duplicates
...
-- Secure community_members table
...
-- Secure content_analytics table
...
-- Secure content_recommendations table  
