...
const Messages = () => {
  ...
  const renderMessagesContent = () => {
    ...
    if (!hasPremium) {
      return (
        <FreemiumTeaser contentType="chat" className="w-full h-screen">
          <div className="h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
            ...
            <div className="relative z-10 flex h-full">
              ...
              <div className="w-80 border-r border-white/10 bg-black/20 backdrop-blur-xl opacity-60">
                <ConversationSidebar 
                ...
                <div className="flex-1">
                  ...
                  >
                    <div className="text-center">
                      ...
                      <p className="text-white/60 text-lg">Upgrade to start messaging</p>
                    </div>
                  </motion.div>
                </div>
              </div>
