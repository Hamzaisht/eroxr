...
export const EnhancedPostCard = ({ 
  ...
  }, [onDelete, post.id, post.creator_id]);
    ...
    <AnimatePresence mode="wait">
      ...
      >
            ...
            <div className="flex items-center gap-2">
              {canDelete && (
                <motion.button
                  ...
                  className="p-2 hover:bg-red-500/20 rounded-full transition-colors duration-300 text-red-400 hover:text-red-300"
                >
        ...
        <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
          <AlertDialogContent className="bg-luxury-darker border border-luxury-primary/20">
            <AlertDialogHeader>
              <AlertDialogTitle className="text-luxury-neutral">Delete Post</AlertDialogTitle>
              <AlertDialogDescription className="text-luxury-muted">
                Are you sure you want to delete this post? This action cannot be undone.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              <AlertDialogCancel 
                className="bg-luxury-dark hover:bg-luxury-dark/80 text-luxury-neutral border-luxury-primary/20"
                disabled={isDeleting}
              >
                Cancel
              </AlertDialogCancel>
