...
export const CinematicFooter = () => {
  ...
  return <motion.footer ref={ref} initial={{
    opacity: 0,
    y: 100
  }} animate={inView ? {
    opacity: 1,
    ...
    duration: 0.8
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          delay: 0.2
            ...
            <motion.h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-white via-pink-200 to-purple-300 bg-clip-text text-transparent" animate={{
            ...
            <motion.div className="w-24 h-1 bg-gradient-to-r from-pink-400 to-purple-400 mx-auto mt-4 rounded-full" animate={{
          ...
          delay: 0.6
            ...
            {socialLinks.map((social, index) => <motion.a key={social.label} href={social.href} className={`text-white/60 ${social.color} transition-all duration-300 group`} whileHover={{
            scale: 1.2,
            y: -5
          }} whileTap={{
            scale: 0.9
            ...
            delay: 0.8 + index * 0.1
                ...
                <div className="relative">
                  ...
                  <motion.div className="absolute inset-0 bg-gradient-to-r from-pink-400 to-purple-400 rounded-full opacity-0 group-hover:opacity-20 -z-10 blur-lg" whileHover={{
                scale: 1.5
              }} />
                </div>
              </motion.a>)}
          ...
          delay: 0.8
            ...
            {legalLinks.map((link, index) => <motion.a key={link.label} href={link.href} className="text-white/60 hover:text-white transition-colors duration-300 text-sm" whileHover={{
            y: -2
          }} initial={{
            opacity: 0
          }} animate={inView ? {
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[...Array(15)].map((_, i) => <motion.div key={i} className="absolute w-1 h-1 bg-white/20 rounded-full" style={{
