...
export function VideoUploadForm({
  ...
  const handleFileSelect = (file: File | null) => {
    ...
    if (file.size > maxSizeInMB * 1024 * 1024) {
      setUploadProgress(prev => ({ ...prev, error: `File size must be less than ${maxSizeInMB}MB` }));
      return;
    }
  ...
  // Revoke file preview
  const revokeFilePreview = (url: string): void => {
              ...
              >
                {previewUrl && (
                  <video
                    ...
                    loop
                    onError={() => setUploadProgress(prev => ({ 
                      ...prev, 
