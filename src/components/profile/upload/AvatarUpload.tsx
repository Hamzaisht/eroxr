    ...
    <>
      <div className="relative group">
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-full bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 p-1 shadow-2xl"
        ...
        <motion.button
          ...
          onClick={() => document.getElementById('avatar-upload')?.click()}
          disabled={isUploading}
          className="absolute -bottom-2 -right-2 w-12 h-12 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full flex items-center justify-center border-4 border-gray-900 shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50"
        >
          {isUploading ? (
