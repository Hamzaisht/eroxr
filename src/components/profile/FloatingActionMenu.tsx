...
import { Plus, Image, Video, Heart, Radio } from "lucide-react";
import { Button } from "@/components/ui/button";

interface FloatingActionMenuProps {
  onCreatePost: () => void;
  onCreateStory: () => void;
  onCreateDatingAd: () => void;
}
...
export const FloatingActionMenu = ({
  ...
  const menuItems = [
    { icon: Image, label: "Create Post", onClick: onCreatePost },
    { icon: Video, label: "Create Story", onClick: onCreateStory },
    { icon: Heart, label: "Dating Ad", onClick: onCreateDatingAd },
  ];
