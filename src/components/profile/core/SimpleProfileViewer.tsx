...
interface SimpleProfileViewerProps {
  profileId: string;
  onEditClick?: () => void;
}

export const SimpleProfileViewer = ({ profileId, onEditClick }: SimpleProfileViewerProps) => {
  const { profile, loading, error } = useSimpleProfile(profileId);
  const { user } = useAuth();
