  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-between items-start">
        <div>
          <h2 className="text-2xl font-bold text-white mb-2">Content Analytics</h2>
          <p className="text-gray-400">Analyze your content performance and optimization opportunities</p>
        </div>
        ...
        <CardContent>
          <div className="space-y-4">
            {data.contentPerformanceData.slice(0, 10).map((content, index) => (
              <div key={content.id || index} className="flex items-center justify-between p-4 bg-luxury-dark rounded-lg border border-luxury-neutral/10">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-luxury-primary/20 rounded-lg flex items-center justify-center">
                    {content.type === 'video' ? <Video className="h-6 w-6 text-luxury-primary" /> :
                     content.type === 'image' ? <Image className="h-6 w-6 text-luxury-primary" /> :
                     <FileText className="h-6 w-6 text-luxury-primary" />}
                  </div>
                  <div>
