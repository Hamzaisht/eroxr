    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-center gap-4">
        <Button
          ...
          className="border-luxury-primary/20 bg-white/5 text-white hover:bg-luxury-primary/20 hover:border-luxury-primary/40 transition-all duration-300 w-14 h-14 rounded-full p-0"
          disabled={isLoading}
        >
        ...
        <Button
          ...
          disabled={isLoading}
        >
          <div className="w-8 h-8 text-[#FF4500]">
